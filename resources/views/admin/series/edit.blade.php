...
@section('content')
<h6 class="c-grey-900">
    {{ trans('global.edit') }} {{ trans('cruds.series.title_singular') }}
</h6>
            ...
            <div class="col-lg-6">
                <div class="form-group {{ $errors->has('warranty') ? 'has-error' : '' }}">
                    ...
                    <select id="warranty" name="warranty" class="form-control select2"  required>
                            ...
                            <option value="local" {{ old('warranty', isset($series) && $series->warranty=='local'? 'selected': '') }}>Local</option>
                            <option value="international"{{ old('warranty', isset($series) && $series->warranty=='international'? 'selected': '') }}>International</option>
                    </select>
